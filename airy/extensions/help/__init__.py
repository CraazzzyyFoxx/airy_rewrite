...
help_embeds = {
    None: hikari.Embed(
        title="ℹ️ __Help__",
        description="""**Welcome to Airy Help!**
...
If you need assistance, found a bug, or just want to hang out, please join our [support server](https://discord.gg/J4Dy8dTARf)!
Thank you for using Airy!""",
...
```Server Settings > Integrations > Airy```
...
If you need any assistance in configuring the bot, do not hesitate to join our [support server](https://discord.gg/J4Dy8dTARf)!""",
        color=ColorEnum.EMBED_BLUE,
    ),
}
...
async def help_cmd(ctx: AirySlashContext, topic: t.Optional[str] = None) -> None:
